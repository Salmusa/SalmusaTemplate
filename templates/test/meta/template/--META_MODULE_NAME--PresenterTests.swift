...
final class --META_MODULE_NAME--PresenterTests: XCTestCase {
    ...
    private var output: --META_MODULE_NAME--ModuleOutput!
    private var interactor: --META_MODULE_NAME--InteractorInput!
    private var router: --META_MODULE_NAME--RouterInput!
    private var view: --META_MODULE_NAME--ViewInput!
